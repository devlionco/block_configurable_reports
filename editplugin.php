...
//    }
    ...
    $PAGE->navbar->add(get_string('managereports','block_configurable_reports'),
        new moodle_url($CFG->wwwroot.'/blocks/configurable_reports/managereport.php', array('courseid'=>$report->courseid)));
    $PAGE->navbar->add($title,
        new moodle_url($CFG->wwwroot.'/blocks/configurable_reports/editcomp.php', array('id'=>$id, 'comp' => $comp)));
