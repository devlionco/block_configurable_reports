...
class report_edit_form extends moodleform {
    function definition() {
        ...
        $mform->addElement('advcheckbox', 'subreport', get_string('subreport','block_configurable_reports') /*,get_string('subreportdescription','block_configurable_reports')*/ );
        ...
        $mform->addElement('advcheckbox', 'cron', get_string('cron','block_configurable_reports'), get_string('crondescription','block_configurable_reports'));
